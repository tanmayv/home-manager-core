...
| task-06 | Phase 2: Add ctl send-pane CLI command | 916458af-be0c-4b7f-8f03-59dfb7ad8fad | In Progress | P0 | task-05 | Messaging integration |
| task-07 | Phase 3: Add remote capture event loops | jetski-coder-agent | Pending | P0 | task-06 | Registry event handoffs |
| task-08 | Phase 4: Go keybindings in agent-communicator | jetski-coder-agent | Pending | P0 | task-07 | TUI integrations |
| task-09 | Phase 5: Set boundaries and write final tests | jetski-coder-agent | Pending | P1 | task-08 | Hardening & Docs |
